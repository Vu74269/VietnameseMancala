...
class BotSelectScene(BaseScene):
	...
	def __init__(
		...
		self.btn_start = Button(pygame.Rect(700, 560, 220, 48), "Tiếp tục", self.body_font, settings.BUTTON_BG, settings.BUTTON_BG_HOVER, settings.BUTTON_TEXT, settings.WHITE)
